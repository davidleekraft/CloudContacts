<? require_once('import.php'); require_once('cred.php');
   require_once('edit-process.php'); require_once('header.html');
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<table class="details" style="width: 50%">
		...
		<tfoot>
			<tr>
				<td colspan="2"> <input type="submit" value="Update" /> OR <a href="main.php"><input type="button" value="Cancel" /></a> </td>
			</tr>
		</tfoot>
		<tbody>
			<tr>
			...
			{ ?>
				<tr>
					<td class="td"> DELETE CURRENT IMAGE </td>
